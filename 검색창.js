...
const floors = {
    '1F': { rooms: ['보건실', '교장실', '행정실', '방송실', '예지홀', '교감실', '1층 교무실', '건강체육교실'], url: "../index/index.html" },
    '2F': { rooms: ['도서관', '체육관', '컴퓨터실'], url: "../2층/2층.html" },
    '3F': { rooms: ['가정실'], url: "../3층/3층.html" },
    '4F': { rooms: ['음악실','미술실','지구과학실','물리실'], url: "../4층/4층.html" },
    '5F': { rooms: ['화학실','생명과학실','급식실'], url: "../5층/5층.html" },
};
